...
import { Upload, Printer, Clock, CreditCard, MapPin, CheckCircle, Shield } from 'lucide-react';
...
const HomePage = () => {
  ...
  useEffect(() => {
    showToast({
      title: "Welcome to PrintEase!",
      description: "Explore our revolutionary printing solution for students."
    });
  }, []);
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl opacity-90 mb-8 max-w-xl">
                Upload documents, choose a shop, customize your order, and skip the queues. PrintEase revolutionizes printing for the digital generation.
              </p>
