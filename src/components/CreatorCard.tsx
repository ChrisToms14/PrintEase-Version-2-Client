...
const CreatorCard: React.FC<CreatorCardProps> = ({ name, college, image, socialLinks }) => {
  return (
    <StyledWrapper>
        ...
        <div className="card">
          ...
          <div className="bottom">
            <div className="social-buttons-container">
              ...
              <a href={socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="social-button">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="svg">
